    ...
    <div className="flex w-full">
      <aside className="w-64 border-r bg-sidebar p-4 text-sidebar-foreground">
        ...
        <nav className="flex flex-col gap-2 text-sm">
          <Link href="/dashboard/admin/user" className="block">
            <span className="inline-block w-full text-left px-3 py-2 rounded-md bg-card border hover:bg-primary/10">Usuarios</span>
          </Link>
          ...
          <Link href="/dashboard/admin/topic" className="block">
            <span className="inline-block w-full text-left px-3 py-2 rounded-md bg-card border hover:bg-primary/10">Temas</span>
          </Link>

          <Link href="/dashboard/admin/subtopic" className="block">
            <span className="inline-block w-full text-left px-3 py-2 rounded-md bg-card border hover:bg-primary/10">Subtemas</span>
          </Link>
        </nav>
      </aside>
