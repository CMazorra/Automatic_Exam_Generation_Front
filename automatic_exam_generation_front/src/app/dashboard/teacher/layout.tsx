  ...
  return (
    <div className="flex w-full">
      <aside className="w-64 border-r bg-sidebar p-4 text-sidebar-foreground">
        <h2 className="text-lg font-semibold mb-4">Panel — Profesor</h2>

        <nav className="flex flex-col gap-2 text-sm">
          <Link href="/dashboard/teacher/teachers" className="block">
          ...
          <Link href="/dashboard/teacher/reports" className="block">
