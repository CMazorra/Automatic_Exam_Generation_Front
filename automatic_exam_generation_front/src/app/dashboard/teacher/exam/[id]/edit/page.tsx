...
        // No usamos toast aquí ya que el error se maneja con el estado 'error' que bloquea la UI.
...
    // Usamos toast.promise para manejar la actualización
    toast.promise(updateExam(id, payload), {
        loading: 'Guardando cambios del examen...',
        success: () => {
        ...
        error: (e) => {
            ...
            return e?.message || "Error al guardar examen. Inténtalo de nuevo.";
        },
    });
  }
