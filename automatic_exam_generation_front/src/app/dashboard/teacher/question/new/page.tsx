...
        setSaving(false)
        return err?.message || "Error al crear la pregunta. Revisa la consola para más detalles.";
      },
    });
  }
...
            />
              {text && text.length < 10 && (
                <p className="text-xs text-red-500 mt-1">El texto de la pregunta debe tener al menos 10 caracteres.</p>
              )}
          </div>
...
            <Button type="submit" disabled={saving || text.length < 10}>{saving ? "Creando..." : "Crear"}</Button>
