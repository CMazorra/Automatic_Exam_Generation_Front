...
const reports: Report[] = [
  {
    ...
    path: '/dashboard/teacher/reports/generatedExams',
  ...
  },
  {
    ...
    path: '/dashboard/teacher/reports/difficultyPerformance',
  ...
  },
  {
    ...
    path: '/dashboard/teacher/reports/examsComparison',
  ...
  },
  {
    ...
    path: '/dashboard/teacher/reports/reviewersLog',
