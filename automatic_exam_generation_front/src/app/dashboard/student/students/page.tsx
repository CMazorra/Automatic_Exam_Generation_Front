  ...
  useEffect(() => {
    ...
    const fetchStudentsSharedSubjects = async () => {
      try {
        ...
        const mySubjectsRaw = await getSubjectsByStudentID(String(currentId)).catch(() => [])
            ...
            <div className="flex-1 space-y-1">
              <div className="flex items-center gap-3">
                ...
                <div className="ml-auto flex gap-2">
                  <Button variant="ghost" size="sm" onClick={() => router.push(`/dashboard/student/students/${user.id_us}`)}>
                  Ver detalles
                  </Button>
                </div>
              </div>
